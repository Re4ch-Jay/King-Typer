            ...
            <section id="section1" className="bg-white dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                    ...
                    <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                        <Link href="/guest" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                            Play Now as Guest!
                        </Link>
                ...
                <button className='text-6xl' onClick={() => scrollToSection("section2")}>👇</button>
            </section>

            <section id="section2" className='bg-white dark:bg-gray-900'>
                <p className="mb-8 text-4xl font-bold text-gray-200">What is <span className='text-primary-400'>King-Typer</span> <span className='text-red-600'>?</span></p>
                <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">A website for typing <span className='text-primary-400'>test based, accuracy, wpm and challenge with others.</span></p>
                <button className='text-6xl' onClick={() => scrollToSection("section3")}>👇</button>
            </section>

            <section id='section3' className='bg-white dark:bg-gray-900'>
                <p className="mb-8 text-4xl font-bold text-gray-200">How to <span className='text-primary-400'>Play</span> <span className='text-red-600'>?</span></p>
                <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
                    <li className='list-none'>1. Start the test and type the text as quickly and accurately as possible.</li>
                    <li className='list-none'>2. The test will end when the time runs out. Your typing speed and accuracy will be displayed.</li>
                    <li className='list-none'>3. Repeat the test as often as you like to improve your typing speed and accuracy.</li>
                </p>
                <button className='text-6xl' onClick={() => scrollToSection("section4")}>👇</button>
            </section>

            <section id="section4" className='bg-white dark:bg-gray-900'>
                <p className="mb-8 text-4xl font-bold text-gray-200">How to <span className='text-primary-400'>improve</span> my typing skill <span className='text-red-600'>?</span></p>
                <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
                    <li className='list-none'>1. Use all 10 fingers.</li>
                    <li className='list-none'>2. Practice regularly.</li>
                    <li className='list-none'>4. Take breaks.</li>
                </p>
                <button className='text-6xl' onClick={() => scrollToSection("section5")}>👇</button>
            </section>

            <section id='section5' className='bg-white dark:bg-gray-900'>
                <p className="mb-8 text-4xl font-bold text-gray-200">Is typing <span className='text-primary-400'>fun</span> <span className='text-red-600'>?</span></p>
